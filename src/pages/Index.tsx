        ...
        <section className="container py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
              className="relative overflow-hidden rounded-2xl p-6 bg-gradient-to-br from-primary/20 via-primary/10 to-transparent border border-primary/10 flex flex-col justify-between min-h-[160px]">
              <div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
              className="relative overflow-hidden rounded-2xl p-6 bg-gradient-to-br from-secondary/50 via-secondary/20 to-transparent border border-secondary/20 flex flex-col justify-between min-h-[160px]">
              <div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
              className="relative overflow-hidden rounded-2xl p-6 bg-gradient-to-br from-accent/40 via-accent/15 to-transparent border border-accent/20 flex flex-col justify-between min-h-[160px]">
              <div>
